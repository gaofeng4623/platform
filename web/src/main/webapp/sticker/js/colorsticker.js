;(function($, window, document, undefined){
	...
	Sticker.prototype = {
		...
		_createSticker : function(event){
			...
			if((document.body.clientWidth + document.body.scrollLeft) - counter*(stickerWidth+20) < (stickerWidth+20)){
				counter = 0;
				line++;
			} 
			stickerEl.style.width = Sticker.options.width;
			stickerEl.style.height = Sticker.options.height;
			stickerEl.style.left = initPosition + counter*(stickerWidth+20) + 'px';
