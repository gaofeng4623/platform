...
var LABEL_COLOR = Color.Firebrick;//Color.get(72, 106, 150);

// Fonts
var NORMAL_FONT = {font: "11px 宋体", opacity: 1, fill: Color.black};
var LABEL_FONT = {font: "12px 宋体", "font-style":"normal", opacity: 1, "fill": LABEL_COLOR};
var LABEL_FONT_SMOOTH = {font: "10px 宋体", "font-style":"normal", opacity: 1, "fill": LABEL_COLOR, stroke: LABEL_COLOR, "stroke-width":.4};
var TASK_FONT = {font: "12px 宋体", opacity: 1, fill: Color.black};
var TASK_FONT_SMOOTH = {font: "12px 宋体", opacity: 1, fill: Color.black, stroke: LABEL_COLOR, "stroke-width":.4};
var POOL_LANE_FONT = {font: "12px 宋体", opacity: 1, fill: Color.black};
var EXPANDED_SUBPROCESS_FONT = {font: "12px 宋体", opacity: 1, fill: Color.black};
...
// TODO: generate polylineId or do something!!
	...
	*/
	...
	drawPoolOrLane: function(x, y, width, height, name){
		...
		if(name != null && name.length > 0) {
			...
			var truncated = this.wrapTextToWidth(name, availableTextSpace);
	...
	*/
	...
	fitTextToWidth: function(original, width) {
		...
		var attr = {font: "11px 宋体", opacity: 0};
	...
	*/
	...
	_drawMultilineText: function(text, x, y, boxWidth, boxHeight, verticalAlign, horizontalAlign) {
		...
		//var font = {font: "11px 宋体", opacity: 1, "fill": LABEL_COLOR};
		...
		while (measurer.getPosition() < measurer.text.getEndIndex()) {
			...
			if (layout != null) {
				...
				if (!availableLinesCount || i < availableLinesCount) {
					...
					layouts.push(this.wrapTextToWidth(layout, boxWidth));
					break;
				}
			}
			i++;
