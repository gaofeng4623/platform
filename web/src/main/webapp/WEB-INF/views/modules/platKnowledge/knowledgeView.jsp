...
//                    multiselect: true,
        ...
        function shoucang(id){
            $.jBox.open("get:${ctx}/platfavoritesitem/platFavoritesItem/formSC?id="+id+"&type=3", "加入收藏", 330, 150,{top:'20%',left:'0%',zIndex:2500,buttons: {  },closed:function(){window.location.href=window.location.href;} });
        }
    </script>
</head>
<body>
...
<div style="float: right">
    <input id="mark" type="button" class="btn" value="收藏" onclick="shoucang('${file.id}')">
    <input id="btnCancel" class="btn" type="button" value="返 回" onclick="javascript:history.go(-1);"/>
</div>
<form id="inputForm" modelAttribute="file" action="${ctx}/knowledge/saveKnowledge" method="post"
