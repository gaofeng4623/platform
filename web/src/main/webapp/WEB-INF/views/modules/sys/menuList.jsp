...
<body>
	...
	<form id="listForm" method="post">
		<table id="treeTable" class="table table-striped table-bordered table-condensed hide">
			<thead ><tr><th style="text-align:center;">名称</th><th style="text-align:center;">链接</th><th style="text-align:center;">排序</th>
			<th style="text-align:center;">可见</th><th style="text-align:center;">权限标识</th><shiro:hasPermission name="sys:menu:edit"><th style="text-align:center;">操作</th></shiro:hasPermission></tr></thead>
			<tbody><c:forEach items="${list}" var="menu">
				<tr id="${menu.id}" pId="${menu.parent.id ne 1?menu.parent.id:0}">
					...
					<td title="${menu.href}" style="text-align:center;">${fns:abbr(menu.href,30)}</td>
					...
					<td title="${menu.permission}" style="text-align:center;">${fns:abbr(menu.permission,30)}</td>
					<shiro:hasPermission name="sys:menu:edit"><td nowrap style="text-align:center;">
