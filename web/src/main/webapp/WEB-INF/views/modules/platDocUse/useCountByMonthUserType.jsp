...
<body>
	<div class="container-fluid" style="border: 1px solid #ddd;background-color: #ddd;">
		<div class="row-fluid" style="padding-top: 5px;">
			<div class="span12" >
				<div id="chartsDiv1" style="height: 300px;"></div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span12" >
				<div id="chartsDiv2" style="height: 300px;"></div>  
			</div>
		</div>
	</div>
		    ...
		    chart : {
		    	events: {
		    		load: function() {
		    			$.ajax({
		    			    type: "post",
		    			    url: "${ctx}/platDocUse/findUseCountByMonthUserTypeEq",
		    			    data: {
		    			    	month: '${month}',
		    			    	usertype: '${usertype}'
		    			    },
		    ...
		    chart : {
		    	...
		    	events: {
		    		load: function() {
		    			$.ajax({
		    			    type: "post",
		    			    url: "${ctx}/platDocUse/findUseCountByClassEq",
		    			    data: {
		    			    	month: '${month}',
		    			    	usertype: '${usertype}'
		    			    },
