...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/notice/noticeInfo/addForm">公告信息添加</a></li>
	</ul><br/>
	<form id="inputForm"  method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea name="content" rows="4" style="width:700px;height:200px;visibility:hidden;display: block;">${noticeInfo.content}</textarea>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group" id="keshi" >
			...
			<div class="controls">
                <sys:treeselect id="office" name="office" checked="true" value="${noticeInfo.office}" labelName="office.name" labelValue="${user.office.name}"
