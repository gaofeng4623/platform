...
<body>
	...
	<script type="text/javascript">
		...
		$.ajax({
			url : "${ctx}/platcomputer/platComputer/getCpuPerfMonth?ip=${ip}",
			type : "post",
			dataType : "json",
			success : function(result) {
				$('#chartsDiv1')
		 ...
		 //mem
		 $.ajax({
			url : "${ctx}/platcomputer/platComputer/getMemPerfMonth?ip=${ip}",
			type : "post",
			dataType : "json",
			success : function(result) {
		...
		//disk 
	 $.ajax({
				url : "${ctx}/platcomputer/platComputer/getDiskPerfMonth?ip=${ip}",
				type : "post",
				dataType : "json",
				success : function(result) {
