...
<body>
	...
	<script type="text/javascript">
		...
		$.ajax({
			url : "${ctx}/platcomputer/platComputer/getCpuPerfDay?ip=${ip}",
			type : "post",
			dataType : "json",
			success : function(result) {
				$('#chartsDiv1')
		 ...
		 //mem
		 $.ajax({
			url : "${ctx}/platcomputer/platComputer/getMemPerfDay?ip=${ip}",
			type : "post",
			dataType : "json",
			success : function(result) {
		...
		//disk 
	 $.ajax({
				url : "${ctx}/platcomputer/platComputer/getDiskPerfDay?ip=${ip}",
				type : "post",
				dataType : "json",
				success : function(result) {
