...
<%@ attribute name="code" type="java.lang.String" required="false" description="编码"%>
<%@ attribute name="codeName" type="java.lang.String" required="false" description="编码名"%>
...
<div class="input-append">
	...
	<input id="${id}Code" name="${codeName}" class="${cssClass}" type="hidden" value="${code}"/>
