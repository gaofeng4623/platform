...
(function() {
	...
	FormbuilderModel = (function(_super) {
		...
		function FormbuilderModel() {
			_ref = FormbuilderModel.__super__.constructor
	...
	FormbuilderCollection = (function(_super) {
		...
		function FormbuilderCollection() {
			_ref1 = FormbuilderCollection.__super__.constructor.apply(this,
					arguments);
			return _ref1;
		}
		...
		ViewFieldView.prototype.render = function() {
			this.$el
					.addClass(
							'response-field-'
									+ this.model
											.get(Formbuilder.options.mappings.FIELD_TYPE))
	...
	EditFieldView = (function(_super) {
		...
		EditFieldView.prototype.addOption = function(e) {
			...
			this.model
					.trigger("change:" + Formbuilder.options.mappings.OPTIONS);
		...
		EditFieldView.prototype.defaultUpdated = function(e) {
			...
			if (this.model.get(Formbuilder.options.mappings.FIELD_TYPE) !== 'checkboxes') {
				this.$el.find(".js-default-updated").not($el).attr('checked',
	...
	BuilderView = (function(_super) {
		...
		BuilderView.prototype.initialize = function(options) {
			...
			this.collection.bind('destroy add reset',
					this.hideShowNoResponseFields, this);
		...
		BuilderView.prototype.addField = function(e) {
			...
			return this.createField(Formbuilder.helpers
...
/*
 * (function() { Formbuilder.registerField('address', { order: 50, view: "<div
 * class='input-line'>\n <span class='street'>\n <input type='text' />\n
 ...
 * <label>Country</label>\n </span>\n</div>", edit: "", addButton: "<span
 * class=\"symbol\"><span class=\"fa fa-home\"></span></span> Address" });
 * 
 * }).call(this);
 */
	...
	Formbuilder
			.registerField(
					'email',
					{
						...
						edit : "",
						addButton : "<span class=\"symbol\"><span class=\"fa fa-envelope-o\"></span></span> 邮箱地址"
					});
	...
	Formbuilder
			.registerField(
					'paragraph',
					{
						...
						addButton : "<span class=\"symbol\">&#182;</span> 文本域",
						defaultAttributes : function(attrs) {
...
/*
 * (function() { Formbuilder.registerField('price', { order: 45, view: "<div
 * class='input-line'>\n <span class='above-line'>$</span>\n <span
 * class='dolars'>\n <input type='text' />\n <label>Dollars</label>\n </span>\n
 * <span class='above-line'>.</span>\n <span class='cents'>\n <input
 * type='text' />\n <label>Cents</label>\n </span>\n</div>", edit: "",
...
/*
 * (function() { Formbuilder.registerField('section_break', { order: 0, type:
 * 'non_input', view: "<label class='section-name'><%=
 * rf.get(Formbuilder.options.mappings.LABEL) %></label>\n<p><%=
 * rf.get(Formbuilder.options.mappings.DESCRIPTION) %></p>", edit: "<div
 * class='fb-edit-section-header'>Label</div>\n<input type='text'
	...
	Formbuilder
			.registerField(
					'website',
					{
						...
						edit : "",
						addButton : "<span class=\"symbol\"><span class=\"fa fa-link\"></span></span> 超链接"
					});
	...
	with (obj) {
		__p += '<label>\n  <input type=\'checkbox\' data-rv-checked=\'model.'
				+ ((__t = (Formbuilder.options.mappings.REQUIRED)) == null ? ''
						: __t)
				+ '\' />\n  Required\n</label>\n<!-- label>\n  <input type=\'checkbox\' data-rv-checked=\'model.'
				+ ((__t = (Formbuilder.options.mappings.ADMIN_ONLY)) == null ? ''
						: __t) + '\' />\n  Admin only\n</label -->';
...
this["Formbuilder"]["templates"]["edit/min_max"] = function(obj) {
	...
	with (obj) {
		__p += '<div class=\'fb-edit-section-header\'>Minimum / Maximum</div>\n\nAbove\n<input type="text" data-rv-input="model.'
				+ ((__t = (Formbuilder.options.mappings.MIN)) == null ? ''
						: __t)
				+ '" style="width: 30px" />\n\n&nbsp;&nbsp;\n\nBelow\n<input type="text" data-rv-input="model.'
				+ ((__t = (Formbuilder.options.mappings.MAX)) == null ? ''
						: __t) + '" style="width: 30px" />\n';
...
this["Formbuilder"]["templates"]["edit/size"] = function(obj) {
	...
	with (obj) {
		__p += '<div class=\'fb-edit-section-header\'>Size</div>\n<select data-rv-value="model.'
				+ ((__t = (Formbuilder.options.mappings.SIZE)) == null ? ''
						: __t)
...
this["Formbuilder"]["templates"]["partials/left_side"] = function(obj) {
	...
	var __t, __p = '', __e = _.escape;
	with (obj) {
		__p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>新增</a></li>\n    <li><a data-target=\'#editField\'>编辑</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    '
...
this["Formbuilder"]["templates"]["view/label"] = function(obj) {
	...
	with (obj) {
		__p += '<label>\n  <span>'
				+ ((__t = (Formbuilder.helpers.simple_format(rf
						.get(Formbuilder.options.mappings.LABEL)))) == null ? ''
						: __t) + '\n  ';
