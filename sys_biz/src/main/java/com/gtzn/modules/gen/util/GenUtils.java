 ...
 */
package com.gtzn.modules.gen.util;
...
import com.gtzn.common.mapper.JaxbMapper;
import com.gtzn.common.utils.DateUtils;
import com.gtzn.common.utils.FileUtils;
import com.gtzn.common.utils.FreeMarkers;
import com.gtzn.common.utils.StringUtils;
import com.gtzn.modules.gen.entity.GenCategory;
...
public class GenUtils {
     ...
     * @param genTable
     */
    public static void initColumnJdbcType(GenTable genTable) {
        for (GenTableColumn column : genTable.getColumnList()) {
            if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "CHAR")){
                column.setJdbcType("CHAR");
            }else if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "VARCHAR")
                    || StringUtils.startsWithIgnoreCase(column.getJdbcType(), "NVARCHAR")
			...
			}else if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "BINARY")
					|| StringUtils.startsWithIgnoreCase(column.getJdbcType(), "VARBINARY")
					|| StringUtils.startsWithIgnoreCase(column.getJdbcType(), "LONGVARBINARY")){
				column.setJdbcType("BINARY");
			}else{
				column.setJdbcType("VARCHAR");
			}
        }
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor():"test");//UserUtils.getUser().getName()
