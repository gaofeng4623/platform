...
public class Role extends DataEntity<Role> {
	...
	private String dataScopeName;// 数据范围
...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	private String statiIds;//角色配置的统计信息的key
...
//	}
	...
	public String getStatiIds() {
		return statiIds;
	}

	public void setStatiIds(String statiIds) {
		this.statiIds = statiIds;
	}
