...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	* @param  wb excel工作薄
	* @param  fileName 文件名
	* @param  request 获取应用请求本地路径
	* @param 
	* @param @throws Exception
	* @return String 本地下载地址
	* @throws
	 */
	public static String writeFile(Workbook wb, String fileName, HttpServletRequest request) throws Exception {
		String path = request.getRealPath("/");
		String url = "/excel/" + fileName +"-"+IdGen.nextLongId()+ ".xls";
